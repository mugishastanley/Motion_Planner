...
if("TRUE" STREQUAL "TRUE")
  set(ur_driver_SOURCE_PREFIX /home/adminuser/ws_moveit/src/universal_robot/ur_driver)
  set(ur_driver_DEVEL_PREFIX /home/adminuser/ws_moveit/devel/.private/ur_driver)
  ...
  set(ur_driver_INSTALL_PREFIX /home/adminuser/ws_moveit/install)
...
if(NOT "/home/adminuser/ws_moveit/devel/.private/ur_driver/include " STREQUAL " ")
  set(ur_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/adminuser/ws_moveit/devel/.private/ur_driver/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adminuser/ws_moveit/src/universal_robot/ur_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ur_driver_NUM_DUMMY_TARGETS)
      set(ur_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ur_driver::wrapped-linker-option${ur_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ur_driver_NUM_DUMMY_TARGETS "${ur_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ur_driver::wrapped-linker-option${ur_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ur_driver_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/adminuser/ws_moveit/devel/.private/ur_driver/lib;/home/adminuser/ws_moveit/devel/lib;/opt/ros/melodic/lib)
