...
if("TRUE" STREQUAL "TRUE")
  set(ur5_e_moveit_config_SOURCE_PREFIX /home/adminuser/ws_moveit/src/universal_robot/ur5_e_moveit_config)
  set(ur5_e_moveit_config_DEVEL_PREFIX /home/adminuser/ws_moveit/devel/.private/ur5_e_moveit_config)
  ...
  set(ur5_e_moveit_config_INSTALL_PREFIX /home/adminuser/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur5_e_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adminuser/ws_moveit/src/universal_robot/ur5_e_moveit_config/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ur5_e_moveit_config_NUM_DUMMY_TARGETS)
      set(ur5_e_moveit_config_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ur5_e_moveit_config::wrapped-linker-option${ur5_e_moveit_config_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ur5_e_moveit_config_NUM_DUMMY_TARGETS "${ur5_e_moveit_config_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ur5_e_moveit_config::wrapped-linker-option${ur5_e_moveit_config_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ur5_e_moveit_config_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/adminuser/ws_moveit/devel/.private/ur5_e_moveit_config/lib;/home/adminuser/ws_moveit/devel/lib;/opt/ros/melodic/lib)
