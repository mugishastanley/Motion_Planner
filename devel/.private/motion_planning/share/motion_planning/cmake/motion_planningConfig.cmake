...
if("TRUE" STREQUAL "TRUE")
  set(motion_planning_SOURCE_PREFIX /home/adminuser/ws_moveit/src/motion_planning)
  set(motion_planning_DEVEL_PREFIX /home/adminuser/ws_moveit/devel/.private/motion_planning)
  ...
  set(motion_planning_INSTALL_PREFIX /home/adminuser/ws_moveit/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adminuser/ws_moveit/src/motion_planning/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT motion_planning_NUM_DUMMY_TARGETS)
      set(motion_planning_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::motion_planning::wrapped-linker-option${motion_planning_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR motion_planning_NUM_DUMMY_TARGETS "${motion_planning_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::motion_planning::wrapped-linker-option${motion_planning_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND motion_planning_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/adminuser/ws_moveit/devel/.private/motion_planning/lib;/home/adminuser/ws_moveit/devel/lib;/opt/ros/melodic/lib)
